...
class CustomFieldData extends Record
{
    ...
    public function getSchema()
    {
        ...
        $schemaResourceInfo = $this->getWrapper()->persistent->get($cacheKey, null);
        ...
        if ($schemaResourceInfo === null) {
            ...
            $this->getWrapper()->persistent->set($cacheKey, $schemaResourceInfo);
        }
    ...
    protected function getSchemaFieldsForCustomFields()
    {
        ...
        foreach ($this->getWrapper()->getCustomFieldsCached() as $customField) {
            $schemaPartialForCustomFields[$customField->apiName] = $customField->getDataType();
        }
